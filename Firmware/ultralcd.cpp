...
//    _lcd_move_menu_axis();
//  }
  void lcd_move_menu_1mmx() {
    move_menu_scale = 1.0;
    lcd_move_x();
  }
  void lcd_move_menu_01mmx() {
    move_menu_scale = 0.1;
    lcd_move_x();
  }

  void lcd_move_menu_1mmy() {
    move_menu_scale = 1.0;
    lcd_move_y();
  }
  void lcd_move_menu_01mmy() {
    move_menu_scale = 0.1;
    lcd_move_y();
  }
    void lcd_move_menu_1mmz() {
    move_menu_scale = 1.0;
    lcd_move_z();
  }
  void lcd_move_menu_01mmz() {
    move_menu_scale = 0.1;
    lcd_move_z();
  }

  void lcd_move_menu_x() {
    START_MENU();
    MENU_BACK(MSG_RETURN);
    MENU_ITEM(submenu, MSG_MOVE_1MM, lcd_move_menu_1mmx);
    MENU_ITEM(submenu, MSG_MOVE_01MM, lcd_move_menu_01mmx);
    #if ENABLED(INDIVIDUAL_AXIS_HOMING_MENU)
      MENU_ITEM(gcode, MSG_AUTO_HOME_X, PSTR("G28 X"));
    #endif
    END_MENU();
  }
  void lcd_move_menu_y() {
    START_MENU();
    MENU_BACK(MSG_RETURN);
    MENU_ITEM(submenu, MSG_MOVE_1MM, lcd_move_menu_1mmy);
    MENU_ITEM(submenu, MSG_MOVE_01MM, lcd_move_menu_01mmy);
    #if ENABLED(INDIVIDUAL_AXIS_HOMING_MENU)
      MENU_ITEM(gcode, MSG_AUTO_HOME_Y, PSTR("G28 Y"));
    #endif
    END_MENU();
  }
  void lcd_move_menu_z() {
    START_MENU();
    MENU_BACK(MSG_RETURN);
    MENU_ITEM(submenu, MSG_MOVE_1MM, lcd_move_menu_1mmz);
    MENU_ITEM(submenu, MSG_MOVE_01MM, lcd_move_menu_01mmz);
    #if ENABLED(INDIVIDUAL_AXIS_HOMING_MENU)
  ...
  void lcd_move_menu() {
    ...
    MENU_ITEM(submenu, MSG_MOVE_X, lcd_move_menu_x);
    MENU_ITEM(submenu, MSG_MOVE_Y, lcd_move_menu_y);
    MENU_ITEM(submenu, MSG_MOVE_Z, lcd_move_menu_z);
